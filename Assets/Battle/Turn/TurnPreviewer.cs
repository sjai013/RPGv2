...
namespace Battle
{
    ...
    public class TurnPreviewer : AbstractTurnDisplay
    {
        ...
        void Start()
        {
            ...
            {
                character.TurnSystem = new Ticks(character);
            }
        ...
        IEnumerator UpdateTurns(List<AbstractBattleCharacter> characters)
        {
            ...
            while (_updatingTurns)
            {
                ...
                if (characters.Any(character => character.TurnSystem.IncrementTime()))
                {
                    AbstractAbility.SelectedAbilityChanged += UpdatePreview;
                    UpdatePreview(AbstractAbility.CurrentSelectedAbility, null, null);
